...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="page-title">Winner List</h4>
                    ...
                    <div class="panel panel-color panel-primary">
                        <div class="panel-heading">
                            <div class="btn-group pull-right">
                                <button type="button" class="btn btn-danger btn-custom btn-rounded waves-effect waves-light">Search</button>
                            </div>
                            <h3 class="panel-title">Winner List</h3>
                        </div>
                        <div class="panel-body" style="background-color:lightblue;">
                            <form class="form-horizontal" role="form">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group has-success">
                                            <label class="col-md-6 control-label">Won Above</label>
                                            <div class="col-md-6">
    ...
    <script type="text/javascript">
        ...
        tblBets = initTable("#table2",
            ...
            ], "<?php echo site_url('Cms_api/get_winner_bets_list') . '/' . $curWeekNo; ?>");
        ...
        function onSearch() {
            ...
            tblSummary.ajax.url("<?php echo site_url('Cms_api/get_result_summary0') ?>" + params);
            tblSummary.ajax.reload();

            tblBets.ajax.url("<?php echo site_url('Cms_api/get_winner_bets_list') ?>" + params);
            tblBets.ajax.reload();
        }
    </script>